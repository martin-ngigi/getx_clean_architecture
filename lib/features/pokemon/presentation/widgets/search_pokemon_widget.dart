...
class SearchPokemonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<PokemonGetx>(builder: (selectedPokemonItem){
      return Padding(
        ...
        child: Column(
          children: [
            ...
            CustomElevatedButtonWidget(
              ...
              callback: () async {
                Get.find<PokemonGetx>().eitherFailureOrPokemon(value: (selectedPokemonItem.number + 1).toString());
