...
import '../getxs/pokemon_getx.dart';
...
class DataWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    PokemonEntity? pokemon = Get.find<PokemonGetx>().pokemon;
    Failure? failure = Get.find<PokemonGetx>().failure;

    late Widget widget;
    if (pokemon != null) {
      widget = GetBuilder<PokemonGetx>(builder: (pokemonGetx){
